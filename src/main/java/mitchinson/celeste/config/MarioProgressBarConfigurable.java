...
public class MarioProgressBarConfigurable implements Configurable {
    ...
    public boolean isModified() {
        return false; // unlike the origin repo, there are no settings

        // MarioProgressBarSettingsState settings =
        //     MarioProgressBarSettingsState.getInstance();
        // boolean modified = !mySettingsComponent
        //     .getChosenCharacter()
        //     .equals(settings.selectedCharacter);
        // modified |=
        //     mySettingsComponent.getChosenCharacter() !=
    ...
    public void reset() {
        ...
        mySettingsComponent.setChosenCharacter(MARIO);
    }
